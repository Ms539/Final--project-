...
// show and hide the modal
  ...
  return (
    <div>
      ...
      <Button style={{marginBottom:'15px',marginLeft:'35px',marginTop:'35px',color:'white',backgroundColor:'black',borderStyle:'groove',borderColor:'black'}} onClick={handleShow}> <strong>Add a product</strong> </Button>
