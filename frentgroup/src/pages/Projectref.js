...
const handleShow = () => setShow(true); 
  ...
  return (
    <div style={{backgroundImage:"url('https://cdn.wallpapersafari.com/16/14/dokjpT.jpg')",backgroundSize:'cover',backgroundRepeat:'no-repeat',backgroundPosition:'center',width:'100%',height:'100%'}}>
        <br/>
        <h3 style={{color:'rgb(239,239,239)',marginLeft:'15px',textShadow:'1px 1px'}}>OUR ACHIEVEMENTS</h3>

                                 {/* add new project */}

      <div>
      {isAuth ?  
      <Button style={{marginBottom:'25px',marginLeft:'35px',marginTop:'15px',color:'white',backgroundColor:'black',borderColor:'white',borderStyle:'groove'}} onClick={handleShow}> <strong>Add command </strong></Button>
      : null }
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton/>
         ...
         <form style={{marginBlock:"20px"}} className="modaladd">
                <label>Image</label>
                <input type='text' name="uploads"  onChange={ (e) =>setFile(e.target.files[0]) }/>
                <label>Title</label>
   ...
   <Modal.Footer>
          ...
          <Button style={{color:'white',backgroundColor:'black',borderColor:'green',borderStyle:'groove'}} type="submit" onClick={handleSubmit} >
            <strong>
            Add
            </strong>
            </Button>
